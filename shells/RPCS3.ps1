# ==================== CONFIGURATION ====================
$source        = "C:\MY_GAMES\RPCS3"
$dest          = "D:\RPCS3"
$logFile       = Join-Path $PSScriptRoot "RPCS3_copy_log.txt"
$errorLog      = Join-Path $PSScriptRoot "RPCS3_errors.txt"
...
Write-Log "=== RPCS3 copy started ===" "Cyan"
...
Get-ChildItem -LiteralPath $source -Recurse -File -ErrorAction SilentlyContinue | ForEach-Object {
    ...
    try {
        ...
        Write-Progress -Id 0 -Activity "RPCS3 Copy - Overall Progress" `
...
Write-Progress -Id 0 -Activity "RPCS3 Copy - Overall Progress" -Completed

Write-Log "" "Magenta"
Write-Log "=== RPCS3 copy finished ===" "Magenta"
